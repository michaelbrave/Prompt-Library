...
CATEGORY_PATTERNS = {
    ...
    "lighting": [
        ...
        r'\b(cinematic\s+lighting|warm\s+lighting|cool\s+lighting|golden\s+light)\b',
        r'\b(long\s+shadows|deep\s+shadows|soft\s+shadows|harsh\s+shadows|chiaroscuro)\b',
        r'\b(lens\s+flare|light\s+bloom|light\s+leak|god\s+rays|specular\s+highlights)\b',
        r'\b(high\s+contrast|low-?key|warm\s+tones|cool\s+tones|color\s+grading)\b',
    ],
    "style_medium": [
        r'\b(oil\s+painting|watercolor|acrylic\s+painting|charcoal\s+sketch|pencil\s+sketch|ink\s+drawing|gouache)\b',
        ...
        r'\b(anime-?inspired|cel-?shaded|manga\s+style|comic\s+style|grunge\s+comic)\b',
        ...
        r'\b(minimalist\s+(?:line\s+art|illustration|sketch))\b',
    ...
    "location_environment": [
        ...
        r'\b(urban|city|downtown|street|alley|alleyway|cobalt-?blue\s+alleyway)\b',
